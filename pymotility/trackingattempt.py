...
cap = cv2.VideoCapture('/Users/elenelominadze/Downloads/Hackathon_data/SpermDB/Sample3/sample3_vid10_sperm16_id31.mp4')
...
while True:
    ...
    p0 = cv2.goodFeaturesToTrack(old_gray, mask=None, maxCorners=5, qualityLevel=0.1, minDistance=70)
    ...
    for i, (new, old) in enumerate(zip(good_new, good_old)):
        ...
        # Calculate velocity
        velocity = displacement * fps  # Multiply by frame rate to get velocity in pixels per second
